...
bool pending=false,loading=true; int tab=0; RealtimeChannel? channel; Map<String,dynamic>? order; String? storeId,storeName;
 ...
 Widget operation()=>ListView(padding:const EdgeInsets.all(18),children:[
  ...
  if(pending) Container(padding:const EdgeInsets.all(22),decoration:BoxDecoration(color:dark,borderRadius:BorderRadius.circular(28)),child:Column(crossAxisAlignment:CrossAxisAlignment.stretch,children:<Widget>[
