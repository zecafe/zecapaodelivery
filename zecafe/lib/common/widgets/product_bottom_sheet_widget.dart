...
class ProductBottomSheetWidget extends StatefulWidget {
  ...
  final int? reelId;
  const ProductBottomSheetWidget({super.key, required this.product, this.isCampaign = false, this.cart, this.cartIndex, this.inRestaurantPage = false, this.fromReview = false, this.reelId});
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          if(product?.verifiedSeller == true)...[
                                            ...
                                            RestaurantVerifiedIconWidget(size: 14,)
                                          ]
