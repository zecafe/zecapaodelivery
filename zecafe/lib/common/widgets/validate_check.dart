...
class ValidateCheck{
  ...
  static String? validateCustomField(String? value, String? message, {required bool isRequired, required CustomInputFieldType fieldType}) {
    if (value == null || value.isEmpty) {
      return !isRequired ? null : message?.tr ?? 'this_field_is_required'.tr;
    }

    if(fieldType == CustomInputFieldType.email){
      return validateEmail(value);
    }
    else if(fieldType == CustomInputFieldType.phone){
