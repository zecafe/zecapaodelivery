...
class OrderService implements OrderServiceInterface {
  ...
  @override
  Future<PaginatedOrderModel?> getRestaurantLastOrders(int restaurantId, {int offset = 1, int limit = 5}) async {
    return await orderRepositoryInterface.getRestaurantLastOrders(restaurantId, offset: offset, limit: limit);
  }

  @override
  Future<PaginatedOrderModel?> getHomeLastOrders({int offset = 1, int limit = 5}) async {
