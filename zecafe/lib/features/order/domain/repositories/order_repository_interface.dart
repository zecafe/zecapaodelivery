...
abstract class OrderRepositoryInterface extends RepositoryInterface {
  ...
  Future<PaginatedOrderModel?> getRestaurantLastOrders(int restaurantId, {int offset, int limit});
  Future<PaginatedOrderModel?> getHomeLastOrders({int offset, int limit});
}