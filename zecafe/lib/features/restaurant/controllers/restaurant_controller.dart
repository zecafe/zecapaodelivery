...
class RestaurantController extends GetxController implements GetxService {
  ...
  Future<void> getRestaurantSearchProductList(String searchText, String? restaurantId, int offset, String type) async {
  ...
  Future<void> getRestaurantCategoryFoods(int restaurantId, String type) async {
    _type = type;
    _categoryIndex = 0;
