    ...
    return Container(
      ...
      child: GetBuilder<RestaurantController>(builder: (restaurantController) {
        return Column(children: [
          ...
          isDesktop ? CheckoutButtonWidget(cartController: cartController, availableList: cartController.availableList, isRestaurantOpen: isRestaurantOpen, fromDineIn: fromDineIn, restaurantId: restaurantId,) : const SizedBox.shrink(),
