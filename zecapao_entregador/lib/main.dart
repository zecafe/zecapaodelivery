...
class ZeEntregadorApp extends StatelessWidget{
 ...
 @override Widget build(BuildContext context)=>MaterialApp(debugShowCheckedModeBanner:false,title:'Entregador Capão Delivery',theme:ThemeData(useMaterial3:true,scaffoldBackgroundColor:const Color(0xFFF3F5F2),colorScheme:ColorScheme.fromSeed(seedColor:const Color(0xFF16B96B),primary:const Color(0xFF171717))),home:const HomePage());
}
